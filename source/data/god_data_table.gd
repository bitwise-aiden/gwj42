...
var data = {
	...
	"amon_ra_paper": GodData.new(
		...
		"Egyptian Sun God",
		{
			"open_taunt": ["Such a stupid mortal. You will never best my strategy!", "You cannot outsmart me!", "My strategy has been used for thousands of years!"],
			"round_draw": ["Matching my strategy? You will surely lose the next one.", "let me try that one again."],
			"round_lose": ["Humph", "You'll never catch on!", "You cannot possibly understand my strategy!"],
